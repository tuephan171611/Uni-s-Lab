...
public class DataScanner {
    ...
    String getStringOnly(String msg) {
        return getString(msg, "Input should only contain letters!", "^[a-zA-Z\\s]+$");
    }
    ...
    String getDate(String msg) {
        ...
        do {
            ...
            // [-]: contain character -
            // \d[1,4]: the number must have 4 digit
    ...
    double getDouble(String msg, String outRangeMsg, double min, double max) {
        ...
        do {
            ...
            // ([5][0]): after a dot just accept digit 5 or 0

            input = getString(msg, "Input just accept x.0 or x.5 number!", "^[0-9]{1,2}\\.5|[0-9]{1,2}\\.0$");
            if (input.isEmpty()) {
                System.out.println("Input could not be empty!");
            } else {
                try {
